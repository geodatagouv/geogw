        ...
        sourceDataset.dataset.distributions.forEach(function (distribution) {
            ...
            if (distribution.type === 'wfs-featureType') {
                ...
                out.resources.push({
                    ...
                    title: simplifiedTypeName + ' (GeoJSON)',
                ...
                out.resources.push({
                    ...
                    title: simplifiedTypeName + ' (Shapefile / WGS-84)',
                ...
                out.resources.push({
                    url: rootUrl + '?format=GeoJSON&projection=WGS84',
                    title: 'Conversion à la volée (GeoJSON)',
                ...
                out.resources.push({
                    url: rootUrl + '?format=SHP&projection=WGS84',
                    title: 'Conversion à la volée (Shapefile / WGS-84)',
