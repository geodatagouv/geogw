...
const { getAllOnLineResources, getAllKeywords, getAllContacts, getConsolidatedExtent, getUpdateFrequency, getDates, getSpatialResolution } = require('./iso19139');
...
function convertFromIso(record) {
    ...
    // Keywords
    dataset.keywords = cleanKeywords(getAllKeywords(record));
