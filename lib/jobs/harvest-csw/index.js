...
class CswHarvestJob extends ServiceSyncJob {
  ...
  _sync() {
    ...
    if (location.includes('geoportal/csw/discovery') || location.includes('tigeo') || location.includes('bdt.gers') || location.includes('geoplateforme17') || location.includes('ids.e-aveyron')) {
      harvesterOptions.defineConstraintLanguage = false
    }
